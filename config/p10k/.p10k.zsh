# Generated by Powerlevel10k configuration wizard on 2025-10-29 at 13:24 CET.
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    ...
    nix_shell               # nix shell (custom label from DEV_SHELL_NAME)
    vcs                     # git status
    # =========================[ Line #2 ]=========================
    newline                 # \n
  ...
  # Show custom shell name from flake (fallback to pure/impure if unset).
  typeset -g POWERLEVEL9K_NIX_SHELL_CONTENT_EXPANSION='${DEV_SHELL_NAME:-$IN_NIX_SHELL}'
  # Snowflake icon for nix shell segment.
